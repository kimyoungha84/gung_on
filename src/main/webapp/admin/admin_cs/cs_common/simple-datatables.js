                ...
                (function() {
                    ...
                    const X = {
                        ...
                        template: (t, e) => `<div class='${t.classes.top}'>\n    ${t.paging && t.perPageSelect ? `<div class='${t.classes.dropdown}'>\n            <label>\n                <select class='${t.classes.selector}'></select> ${t.labels.perPage}\n            </label>\n        </div>` : ""}\n 
						   ...
						   ${t.searchable ? `<div class='${t.classes.search}' style = "width: 300px; height : 69px; display: flex; align-items: center; gap: 8px;">							<div class="dataTable-category-filter ms-2">
						        <select id="categoryFilter" class="form-select form-select-sm w-auto">
						            <option value="">제목</option>
						            <option value="전자">내용</option>
						        </select>
						    </div>\n            
