...
<a href="javascript:location.replace('http://localhost/GungOn/mainpage/mainpage.jsp')" class="btn btn-secondary btn-sm">메인으로</a>
</div>
</div>
</c:when>
<c:otherwise>
...
<a href="http://localhost/GungOn/mainpage/mainpage.jsp">메인화면</a>
