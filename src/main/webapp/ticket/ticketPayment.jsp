...
<!-- CSS 설정 -->
<link rel="stylesheet" type="text/css" href="http://localhost/GungRemake333/ticket/css/payment.css"/>
<!-- jquery CDN -->
<script src="https://ajax.googleapis.com/ajax/libs/jquery/2.2.4/jquery.min.js"></script>

<script src="http://localhost/GungRemake333/ticket/js/payment.js" type="text/javascript"></script>
...
<body>
	...
	<form id="calcFrm" action="http://localhost/GungRemake333/ticket/ticketProcess/ticket_calc_procss.jsp" method="post">
	    <div class="btnGroup">
