...
<c:import url="http://localhost/GungRemake333/common/jsp/header.jsp"/>	
<title>예매</title>
...
<link rel="stylesheet" type="text/css" href="http://localhost/GungRemake333/ticket/css/ticket_ver0514.css"/>
	
<!-- favicon 설정 -->
<link rel="shortcut icon" href="http://localhost/GungRemake333/common/images/gungOnFavicon.ico"/>
...
<div class="wrap">
    <form action="http://localhost/GungRemake333/ticket/ticketProcess/ticket_process.jsp" name="viewDateFrm" method="post">
    ...
    <div class="right">
		<div class="ticket_box">
			...
			<div class="viewTitle">
				<img src="http://localhost/GungRemake333/ticket/images/ico_date.png" width="20px"/><span class="view">관람일자</span>
			</div><!--viewTitle-->
			<!-- <form action="" name="viewDateFrm" method="post"> -->
				...
				<div class="selectDesign viewDate" id="viewDate" >
					...
					<img src="http://localhost/GungRemake333/ticket/images/downArrow.png" width="16px" id="arrow" class="arrow"/>	
				</div><!--selectionDesign-->
				</div><!-- viewDateParent -->
			<!-- </form>	 --><!-- viewDateFrm -->
			...
			<div class="viewTitle"> 
				<img src="http://localhost/GungRemake333/ticket/images/ico_person.png" width="20px"/><span class="view">관람인원</span>
			</div><!--viewTitle-->
			...
			<div class="personWrap"><!-- 부모 -->
				...
				<div class="selectDesign viewPersonNum" id="viewPersonNum" onclick="changeStatus('.viewPersonNum','.classificationWrap')">
					...
					<img src="http://localhost/GungRemake333/ticket/images/downArrow.png" id="arrow" class="arrow"  width="16px" />
				...
				<div class="classificationWrap" style="display:none"><!-- 자식 -->
				    ...
				    <tbody>
				        ...
				        <td style="width:43%;">
				        	...
				        	<div class="minusDiv"><img src="http://localhost/GungRemake333/ticket/images/minusImg.png" class="minusImg minusAdultImg"/></div>
				        	<input type="text" class="person adult" name="adult" value="0" readonly style="border:1px #333 solid; width:44px"/>
				        	<div class="plusDiv"><img src="http://localhost/GungRemake333/ticket/images/plusImg.png" class="plusImg plusAdultImg"/></div>
				            </div>
				        </td>
				    </tr>
				    <tr>
				        ...
				        <td>
				           <div class="classifiationTable">
				        	<div class="minusDiv"><img src="http://localhost/GungRemake333/ticket/images/minusImg.png" class="minusImg minusKidImg" id="minusImg"/></div>
				        	<input type="text" class="person kid" name="kid" value="0" readonly style="border:1px #333 solid; width:44px">
				        	<div class="plusDiv"><img src="http://localhost/GungRemake333/ticket/images/plusImg.png" class="plusImg plusKidImg" id="plusImg"/></div>
				            </div>
				        </td>
				    </tr>
				    </tbody>
			...
			<div class="viewTitle">
				<img src="http://localhost/GungRemake333/ticket/images/ico_person.png" class="20px"/><span class="view">해설관람</span><span style="font-size: 11px;">(선택사항)</span>		
			</div><!--viewTitle-->
    ...
    <div class="left">
		...
		<div data-slick='{}' class='slider' style=" margin-left: 35px;">
		  <img src="http://localhost/GungRemake333/ticket/images/Gyeongbokgung.jpg"/>
		  <img src="http://localhost/GungRemake333/ticket/images/Gyeongbokgung2.jpg"/>
		  <img src="http://localhost/GungRemake333/ticket/images/Gyeongbokgung3.jpg"/> 
...
<c:import url="http://localhost/GungRemake333/common/jsp/footer.jsp"/>
</body>
