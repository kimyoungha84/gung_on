...
public class SitePropertyVO {
	...
	private void setConfig() {
		...
		gungPicturePath="http://211.63.89.140${pageContext.request.contextPath}/ticket/images/";
		...
		QRStorePath="http://211.63.89.140${pageContext.request.contextPath}/ticket/ticketProcess/qr_process.jsp";
		
		//내부 컴퓨터의 저장 경로
		uploadQRPathInCom="${pageContext.request.contextPath}/common/images/upload/QR/";
